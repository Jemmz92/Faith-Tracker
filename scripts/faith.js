...
Hooks.on("renderActorSheet", (app, html) => {
  ...
  if (!faithTab.find(".faith-panel").length) {
    ...
    faithTab.html(`
      <div class="faith-panel">
        ...
        <div class="faith-deity-info" style="margin-top:10px;">
          <img src="${DEITIES[currentDeity].image}" style="max-width:520px; max-height:520px; display:block; margin-bottom:10px;">
    ...
    faithTab.find(".faith-deity").change(function() {
      ...
      infoDiv.html(`
     <img src="${DEITIES[selected].image}" style="max-width:520px; max-height:520px; display:block; margin-bottom:10px;">
